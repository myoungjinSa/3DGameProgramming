...
#define EXPLOSION_DEBRISES		240												//폭발물 잔해 개수


#define DISTANCE_TO_TARGET_OBJECT	5.0f

#define EPSILON						(1.0e-5f)										//매우 작은 수를 의미

#define HALF_WIDTH			45.0f
#define HALF_HEIGHT			45.0f
#define HALF_DEPTH			500.0f

#define MAX_BOX_COUNT		30

inline bool IsZero(float fValue) { return((fabsf(fValue) < EPSILON)); }				//fabsf(x) x의 절대값 반환
