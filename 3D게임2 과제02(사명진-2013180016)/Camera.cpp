...
void CCamera::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	//XMMatrixMultiply(XMLoadFloat4x4(&m_pcbMappedCamera->m_xmf4x4View), XMLoadFloat4x4(&m_pcbMappedCamera->m_xmf4x4Projection));
	
	//XMFLOAT4X4 ViewProjection = Matrix4x4::Identity();
/*Edit*///	m_xmf4x4ViewProjection=Matrix4x4::Multiply(m_pcbMappedCamera->m_xmf4x4View,m_pcbMappedCamera->m_xmf4x4Projection);
/*Edit*/	m_xmf4x4ViewProjection=Matrix4x4::Multiply(m_xmf4x4View, m_xmf4x4Projection);
