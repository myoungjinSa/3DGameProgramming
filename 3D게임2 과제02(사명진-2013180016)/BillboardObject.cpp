...
void CTexturedTransformObject::Animate(float fTimeElapsed, CCamera *pCamera,bool IsIntersect)
{
	...
	//m_xmf4x4Texcoord._11 = XMScalarCos(XMConvertToRadians(0.5f));
	//m_xmf4x4Texcoord._12 = -XMScalarSin(XMConvertToRadians(0.5f));
	//m_xmf4x4Texcoord._13 = 0.0f;
	//m_xmf4x4Texcoord._21 = XMScalarSin(XMConvertToRadians(0.5f));
	//m_xmf4x4Texcoord._22 = XMScalarCos(XMConvertToRadians(0.5f));
	//m_xmf4x4Texcoord._23 = 0.0f;
