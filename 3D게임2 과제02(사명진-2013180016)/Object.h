...
public:
	...
	//virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera,bool bFillmode);
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera,int objNum,UINT rasterNum);
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera, UINT nInstance,int objNum,UINT rasterNum);
...
public:
	...
	std::vector<XMFLOAT3> vecTreePosition;
private:
...
public:
	...
	void SetTreePosition(int index,XMFLOAT3 &v);
...
public:
	...
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList,bool bFillmode ,CCamera *pCamera = NULL);
