...
//CPlayer::CPlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, void *pContext, int nMeshes) : CFrameObject()
//{
...
//	}
//
//	CFrameObject::ReleaseShaderVariables();
//}
//
...
//}
//
//void CPlayer::Render(ID3D12GraphicsCommandList *pd3dCommandList,bool bFillmode ,CCamera *pCamera)
//{
//	DWORD nCameraMode = (pCamera) ? pCamera->GetMode() : 0x00;
//	if (nCameraMode == THIRD_PERSON_CAMERA)
//	{
//		//pd3dCommandList->SetGraphicsRootDescriptorTable(2, m_d3dCbvGPUDescriptorHandle);		//상수 버퍼
//		CFrameObject::Render(pd3dCommandList, pCamera);
//	}
//}
//
//
...
//
//	//SetMesh(LoadMeshInfoFromFile("Models/Apache.bin"));
//
//
...
{
	DWORD nCameraMode = (pCamera) ? pCamera->GetMode() : 0x00;
	if (nCameraMode == THIRD_PERSON_CAMERA) CFrameObject::Render(pd3dCommandList, pCamera);
}
...
CAirplanePlayer::CAirplanePlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	...
	CFrameObject *pGameObject = CFrameObject::LoadGeometryFromFile(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, "Models/Apache.bin");
...
CCamera *CAirplanePlayer::ChangeCamera(DWORD nNewCameraMode, float fTimeElapsed)
{
	...
	case THIRD_PERSON_CAMERA:
		...
		m_pCamera = OnChangeCamera(THIRD_PERSON_CAMERA, nCurrentCameraMode);
		m_pCamera->SetTimeLag(0.25f);
		m_pCamera->SetOffset(XMFLOAT3(0.0f, 30.0f, -140.0f));
...
CTerrainPlayer::CTerrainPlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, void *pContext, int nMeshes) : CPlayer(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, pContext, nMeshes)
{
	...
	//CSkullMesh *pCubeMesh = new CSkullMesh(pd3dDevice, pd3dCommandList);
	//CCarMesh *pCubeMesh = new CCarMesh(pd3dDevice, pd3dCommandList);
