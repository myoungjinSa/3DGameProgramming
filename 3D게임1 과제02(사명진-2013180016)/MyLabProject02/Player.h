...
public:
	...
	void SetRightVector(XMFLOAT3& xmfRight) {
		m_xmf3Right = xmfRight;
	}
	void SetUpVector(XMFLOAT3& xmfUp) {
		m_xmf3Up = xmfUp;
	}

	void SetLookVector(XMFLOAT3& xmfLook) {
		m_xmf3Look = xmfLook;
	}

	void LookAt(XMFLOAT3& xmf3LookAt, XMFLOAT3& xmf3Up);

	void focus_On(CGameObject* pSelectObject);
	...
	CBulletMeshDiffused *pBulletMesh = NULL;
	CBulletObject **m_pBulletObjects = NULL;

	BoundingSphere *m_sphereBox;			//반경 50m구체 충돌 박스

	//static
	static int m_countBullet;
	static int m_currentBullet;
