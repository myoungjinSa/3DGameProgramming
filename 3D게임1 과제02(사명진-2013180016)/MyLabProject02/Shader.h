...
public:
	...
	virtual void AnimateObjects(float fTimeElapsed, CPlayer* player);
	...
	virtual void CheckObjectByBulletCollisions(CPlayer *player);
	virtual void CheckObjectByWallCollisions(CPlayer *player);
	virtual void CheckObjectByObjectCollisions();
	virtual void CheckObjectByPlayerCollisions(CPlayer *player);

	void GenerateBoxObject(int num,CPlayer *player);
	void InitAll(CPlayer *player);
...
protected:
	...
	float m_RedElapsedTimes = 0.0f;

	//CCubeMeshDiffused *pCube = NULL;
