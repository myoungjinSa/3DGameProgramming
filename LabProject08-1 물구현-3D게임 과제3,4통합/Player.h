...
class CPlayer : public CFrameObject
{
protected:
...
public:
	static int m_countMissile;
	static int m_currentMissile;

	static void LoadMissile(int number);
...
class CBackMirrorPlayer : public CPlayer
{
public:
	CBackMirrorPlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList);
	virtual ~CBackMirrorPlayer();
