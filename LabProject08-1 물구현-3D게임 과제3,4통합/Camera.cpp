...
void CCamera::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	//XMMATRIX m_xmf4x4ViewProjection = Matrix4x4
	...
	//XMFLOAT3 xmViewPort = XMFLOAT3(GetViewport().Width, GetViewport().Height, 0.0f);
	//::memcpy(&m_pcbMappedCamera->m_xmfvViewPort, &xmViewPort, sizeof(XMFLOAT3));
	
	//std::cout << m_pcbMappedCamera->m_xmfvViewPort.x << "," << m_pcbMappedCamera->m_xmfvViewPort.y << std::endl;
